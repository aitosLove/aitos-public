...
export interface SwapOptions {
  ...
  STABLE_COIN: OnChainCoin;
}

export async function executeAdjustment({
  targetPortfolio,
  originalPortfolio,
  swapOptions: { swap, STABLE_COIN },
}: {
  targetPortfolio: TokenOnTarget[];
  ...
  try {
    ...
    await planAdjustments({
      originalPortfolio,
      targetPortfolio: normalizedTargetPortfolio,
      swapOptions: { swap, STABLE_COIN },
    });
