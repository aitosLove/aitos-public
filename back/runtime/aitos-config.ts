...
import { ETH,BTC, APT, THL,PROPS,AMI } from "@/src/modules/cmcAnalysis/cmc/coin_apt";
import { CMC_TOKEN } from "@/src/modules/cmcAnalysis/cmc/type";
import { RateAnalysis } from "@/src/modules/cmcAnalysis/type";


export const analysis_portfolio_apt: RateAnalysis[] = [
  {
    assetA: ETH,
    assetB: BTC,
