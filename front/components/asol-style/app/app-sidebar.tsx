  ...
  return (
    <Sidebar className="border-r border-border bg-sidebar-background text-sidebar-foreground w-64 shadow-lg rounded-none overflow-hidden">
      <SidebarContent className="flex flex-col h-full">
            ...
            <SidebarMenuItem>
              <div className="flex items-center space-x-3 py-2">
                <div className="px-2 flex items-center justify-center">
                  <ThemedLogo size="regular" />
                </div>
                {/* <span className="font-bold text-xl tracking-tight bg-gradient-to-r from-accent to-accent/70 text-transparent bg-clip-text">ASOL</span> */}
              </div>
            </SidebarMenuItem>
          </SidebarMenu>
        </SidebarHeader>
          ...
          <SidebarGroupContent className="py-6 px-3">
            <SidebarMenu className="space-y-2">
              ...
              <div className="pt-6 pb-2 space-y-2">
                <h3 className="text-xs uppercase tracking-wider font-semibold mb-3 px-4 text-purple-500/100">
                  Blueprints
                </h3>
                ...
                <SidebarMenuItem>
                  <SidebarMenuButton
                    ...
                    className="transition-all duration-200 ease-in-out rounded-xl hover:bg-sidebar-accent group w-full"
                  >
                    <a href="/sol-market" className="flex items-center py-3 px-4">
                      <div className="p-2 rounded-lg bg-sidebar-accent/30 mr-3 ">
                        <Blocks size={16} className="" />
                      </div>
                      <span className="font-medium ">Solana Analysis</span>
                    </a>
                  </SidebarMenuButton>
                </SidebarMenuItem>
        ...
        <SidebarFooter className="p-5 border-t border-border bg-sidebar-background/50 backdrop-blur-sm">
