...
const TOKEN_FIXED_COLORS: Record<string, string> = {
  ...
  TRUMP: "#E81123", // Trump token - Using a distinctive red
  JUP: "#F7A600",   // Jupiter - Using their brand orange/yellow
  PYTH: "#00C2FF",  // PYTH - Using a light blue similar to their brand
  RAY: "#6D28D9",   // Raydium - Using a deep purple
};
