  ...
  return (
    <div className="bg-card-background p-6 rounded-xl border border-border shadow-sm">
      <div className="flex justify-between items-center mb-6">
        <div>
          <h2 className="text-xl font-semibold text-accent">Portfolio Adjustments</h2>
        ...
        {history.length === 0 ? (
          ...
          history.map((item, index) => {
            ...
            return (
              <div
                key={index}
                className="rounded-xl border border-border/60 hover:border-border bg-card/50 hover:bg-muted/30 transition-all duration-200"
              >
