...
export function PositionCard() {
  ...
  return (
    <div className="bg-card-background p-6 rounded-xl border border-border shadow-sm">
      <div className="flex justify-between items-center mb-2">
        <div>
          <h2 className="text-xl font-semibold text-accent">Portfolio</h2>
  ...
  <div className="flex items-center gap-3 p-4  rounded-xl transition-colors group">
  ...
  <div className="flex items-center gap-3 p-4  rounded-lg transition-colors group">
    <div className="flex items-center justify-center w-10 h-10 rounded-md ">
