import { getChat, saveChat } from "@/app/chat/(chat)/lib/actions/chat";
import { generateRelatedQuestions } from "@/app/chat/(chat)/lib/agents/generate-related-questions";
import { ExtendedCoreMessage } from "@/app/chat/(chat)/lib/types";
import { convertToExtendedCoreMessages } from "@/app/chat/(chat)/lib/utils";
...
export async function handleStreamFinish({
  ...
  try {
    const extendedCoreMessages =
      convertToExtendedCoreMessages(originalMessages);
